...
character = GameSprite(pygame.image.load(os.path.join(image_path, "character.png")), character_x_pos, character_y_pos)
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # 공과 캐릭터 충돌 처리
        if pygame.sprite.collide_rect_ratio(0.7)(character_rect, ball_rect):
            running = False
            break
